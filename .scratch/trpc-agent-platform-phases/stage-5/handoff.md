...
- A dangerous Tool returns `confirmation_required` and a Tenant-scoped
  confirmation ID. After an authorized decision, the same request ID is retried;
  repeated decisions/evaluations do not start a second execution.
